...
# For contributors
If you want to jump right into contributing to this library, click [here](https://github.com/santosmarco/coinlib#to-do-list) to be taken directly to our to do list. Following this list is not mandatory, but is highly recommended.
